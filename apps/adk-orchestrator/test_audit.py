...
class TestAuditLogger:
    ...
    def test_audit_logs_structured_json(self, caplog):
        ...
        # Act
        await audit(event_name, principal, tenant, data)
    ...
    @pytest.mark.asyncio
    async def test_audit_with_event_store_success(self):
    ...
    @pytest.mark.asyncio
    async def test_audit_with_event_store_failure_continues(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_audit_without_event_store(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_audit_with_complex_data(self, caplog):
